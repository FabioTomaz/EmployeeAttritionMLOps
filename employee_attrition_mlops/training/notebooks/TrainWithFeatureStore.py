...
# ``employee_attrition_mlops/databricks-resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-employee-attrition-mlops-experiment",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev-employee-attrition-mlops-model", label="Model Name"
)
