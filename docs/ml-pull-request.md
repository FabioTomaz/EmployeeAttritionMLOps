...
Opening a pull request will trigger a[workflow](../.github/workflows/employee-attrition-mlops-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://your-staging-workspace.cloud.databricks.com#mlflow/models/staging-employee-attrition-mlops-model)
* [Prod workspace registered model](https://your-prod-workspace.cloud.databricks.com#mlflow/models/prod-employee-attrition-mlops-model)
