...
```
employee-attrition-mlops         <- Root directory. Both monorepo and polyrepo are supported.
│
├── employee_attrition_mlops       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
