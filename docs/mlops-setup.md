...
[ML Config](../employee_attrition_mlops/databricks-resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore employee_attrition_mlops/databricks-resources/README.md
...
Follow the instructions in [employee-attrition-mlops/databricks-resources/README.md](../employee_attrition_mlops/databricks-resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../employee_attrition_mlops/databricks-resources/README.md)  to propose, test, and deploy
